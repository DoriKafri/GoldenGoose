...
def simulate_activity(db: Session) -> dict:
    ...
    # ── 4. Simulated bug creation disabled — tracker is for real user-submitted bugs only ──

    # ── 5. Simulated bug transitions disabled — bugs are managed by real users now ──

    # ── 6. Simulated bug comments disabled — comments are from real users now ──
